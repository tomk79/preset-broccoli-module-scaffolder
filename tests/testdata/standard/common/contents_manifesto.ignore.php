...
<!-- jQuery -->
<script src="<?= htmlspecialchars($px->href('/tests/testdata/standard/common/scripts/jquery-1.10.1.min.js')); ?>" type="text/javascript"></script>

<!-- Contents Styles -->
<link rel="stylesheet" href="<?= htmlspecialchars($px->href('/tests/testdata/standard/common/styles/contents.css')); ?>" type="text/css" />
<script src="<?= htmlspecialchars( $px->href('/tests/testdata/standard/common/scripts/contents.js') ); ?>"></script>
